...
describe('create room', () => {
    ...
    it('should create room regular', () => {
        let schemeHelperMock : any = createMock({type: "regular", scheme: [0, .5, 1, 2, 3, 5, 8, 13, 20]});
    ...
    it('should create room fibonacci', () => {
        let schemeHelperMock : any = createMock({type: "fibonacci", scheme: [0,1,2,3,5,8,13,21]});
    ...
    it('should create room custom', () => {
        let schemeHelperMock : any = createMock({type: "custom", scheme: ['eerste','B. building',2,3,5,8,'number',21]});
        const roomhelper = new RoomHelper(schemeHelperMock, new InMemoryDatabase<Room>())
...
describe('save room', () =>{
    it('should save one room', () => {
        ...
        const room = {id: 1, name:"scrum", cardScheme: {type: "fibonacci", scheme: [0,1,2,3,5,8,13,21]}, timeout:0}
    ...
    it('should save multiple rooms', () => {
        const inMemoryDB = new InMemoryDatabase<Room>();
        const roomhelper = new RoomHelper(new SchemeHelper, inMemoryDB)
        const roomOne = {id: 1, name:"scrum", cardScheme: {type: "fibonacci", scheme: [0,1,2,3,5,8,13,21]}, timeout:0}
        const roomTwo ={id: 2, name:"bluefront", cardScheme: {type: "custom", scheme: ['eerste','B. building',2,3,5,8,'number',21]}, timeout:0}
